...
public class DBConstants {
    ...
    public static final String GET_PARKING_SPOT = "select p.PARKING_NUMBER, p.TYPE, p.AVAILABLE  from parking p where p.parking_number = ? ";
    ...
    public static final String GET_RECURRING_USER = "select t.ID from ticket t where t.VEHICLE_REG_NUMBER = any( select t.VEHICLE_REG_NUMBER from ticket t where t.VEHICLE_REG_NUMBER = ?)";
}
